...
### Имейте ввиду: 
Микросервис по умолчанию работает с классом `"inetOrgPerson"`. Если на вашем LDAP-сервере используется другой класс для хранения пользователей, то измените в следующей строке название класса на ваш: `target_classes = ['inetOrgPerson']` (В описаниях ошибок также написано `"inetOrgPerson"`, при необходимости внесите изменения и там)