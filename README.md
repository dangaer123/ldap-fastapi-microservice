...
### Имейте ввиду: 
*   Микросервис по умолчанию работает с классом `"inetOrgPerson"`. Если на вашем LDAP-сервере используется другой класс для хранения пользователей, то измените в следующей строке название класса на ваш: `LDAP_USER_CLASS = "inetOrgPerson"`
    *   То же самое касается и имени атрибута поиска, по которому фильтруются пользователи. Измените `LDAP_LOGIN_ATTRIBUTE = "uid"` на ваш. 
